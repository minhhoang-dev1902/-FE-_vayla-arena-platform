...
export default function MainLayout({ children }: { children: React.ReactNode }) {
	return (
		<AppShellNavProvider>
			<div className="relative flex min-h-dvh w-full flex-col px-6">
				<MainHeader />
				<div className="mt-[11px] relative mx-auto flex w-full max-w-(--app-view-max-width,80rem) flex-1 flex-col pb-20 lg:px-4 lg:pb-3">
